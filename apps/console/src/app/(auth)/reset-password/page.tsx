...
function ResetPasswordForm() {
  ...
  useEffect(() => {
    // Supabase redirects with access_token + refresh_token in hash
    // The @supabase/ssr middleware handles the session exchange automatically
  ...
  if (success) {
    return (
      <div className="bg-gray-800 rounded-lg shadow-xl p-8 text-center">
        ...
        <Link href="/login" className="inline-flex items-center gap-2 text-blue-400 hover:text-blue-300">
          Go to login now
        </Link>
      </div>
    );
  ...
  return (
    <div className="bg-gray-800 rounded-lg shadow-xl p-8">
      ...
      <div className="mt-6 text-center">
        <Link href="/login" className="inline-flex items-center gap-2 text-blue-400 hover:text-blue-300 text-sm">
          <ArrowLeft size={16} />
          Back to login
        </Link>
      </div>
